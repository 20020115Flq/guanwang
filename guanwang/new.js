...
$('.wenzi-1').mouseover(function () {
    $(this).addClass("wenzi-1-yanse")
})
$('.wenzi-1').mouseout(function () {
    $(this).removeClass("wenzi-1-yanse")
})
...
$('.dhkj').click(function () {
    ...
    if ($(this).siblings().find('.dhkj-1').css("display","block")) {
        $(this).siblings().find('.dhkj-1').css("display","none")
        $(this).siblings().removeClass("biankuang")
        $(this).siblings().find('.tap-zuo').removeClass("zuo")
        $(this).siblings().find('.tap-you').removeClass("you")
    }
})
...
$('.fueu-hezi-1').mousemove(function(){
    $(this).addClass("hezikuang")
})
$('.fueu-hezi-1').mouseleave(function(){
    $(this).removeClass("hezikuang")
})